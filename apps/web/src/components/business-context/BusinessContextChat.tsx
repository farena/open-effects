...
const STORAGE_KEY = "oe-chat-messages-business-context";
const SESSION_KEY = "oe-chat-session-business-context";
      ...
      <div className="px-4 py-3 border-b border-border flex items-start justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Tell me about your brand — I&apos;ll save it for every video.
          </p>
        </div>
        {messages.length > 0 && (
          <button
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto">
        {messages.length === 0 && (
          <div className="p-6 text-center text-muted-foreground">
            ...
            <p className="text-xs">
              Start with: &ldquo;My brand is...&rdquo; or paste your website
              URL.
            </p>
          </div>
        )}
